...
<nav class="fixed w-full flex justify-between bg-white dark:bg-gray-800 mb-16 border-t-blue-600 border-b-black border-t-8 z-50 backdrop-blur-md bg-white/30 dark:bg-black/30 border-b"
        ...
        <div @click.away="menu=false" class="relative md:hidden">
            ...
            <div x-show="menu" x-transition:enter="transition ease duration-100 transform"
                ...
                <span
                    class="absolute top-0 left-0 w-2 h-2 bg-white transform rotate-45 -mt-1 ml-[89px] border-gray-300 border-l border-t z-20 dark:bg-gray-700"></span>
                <div
                    class="bg-white overflow-auto rounded-lg shadow-md w-full relative z-10 border border-gray-300 text-gray-800 text-xs dark:bg-gray-700 dark:text-white">
                    <ul>
                        <li>
                            <x-dropdown-menu href="#profil">Profil</x-dropdown-menu>
                            <x-dropdown-menu href="#ebook">E-book</x-dropdown-menu>
        ...
        <ul class="mt-lg-0 hidden md:flex md:flex-row md:items-center">
            ...
            <li class="hover:dark:bg-gray-700 h-full flex md:items-center px-3 hover:rounded-md">
                <a class="dark:text-white font-bold text-md" href="#ebook">E-book</a>
            </li>
            <li class="hover:dark:bg-gray-700 h-full flex md:items-center px-3 hover:rounded-md">
