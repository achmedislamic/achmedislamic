...
@section('konten')
    ...
    <div class="container my-5 px-4 dark:text-white scroll-mt-24" id="proyek">
        <div class="flex flex-col">
            ...
            <p class="text-white rounded-md p-3 bg-red-500 mb-3"><strong>Maaf, saat ini saya tidak menerima proyek hingga akhir bulan Juni 2023. Namun jika Anda memiliki keperluan lain, silakan email saya di: achmedislamic@outlook.com. Terima kasih atas pengertiannya</strong></p>
            <ul>
                <x-list-card>
